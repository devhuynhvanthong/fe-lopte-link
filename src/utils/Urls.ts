...
export const BASE_URL_LOGIN_ADMIN = `${DOMAIN_ACCOUNT}/login?domain=${Library().base64Encode("https://link.aigoox.com/admin")}&session=expired`
export const BASE_URL_LOGIN_DASHBOARD = `${DOMAIN_ACCOUNT}/login?domain=${Library().base64Encode("https://link.aigoox.com/dashboard")}&session=expired`
